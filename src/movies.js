...
class Movies extends Component {
  ...
  constructor(props){
    ...
    axios.post('http://10.90.90.102:3002/movies').then(res=>{
  ...
  render() {
    ...
    const stories = this.state.stories.slice(3,6).map((d) => 
            ...
            <Row style={rowStyle}>
              <Col sm="4">
                <img src="movies.jpeg" height="100px" width="100px" alt="poster"/>
              </Col>
              <Col sm="8" key={d.id}>{d.description}<NavLink key={d.id} to="/Story/:id">Read-more</NavLink></Col>
            </Row>
    ...
    <Container>
        <Row>
          ...
          <Col sm="4">
            <Card>
              <CardImg top width="100%" src="movies.jpeg" alt="Card image cap" />
              <CardBody>
