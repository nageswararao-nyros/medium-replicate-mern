...
class News extends Component {
  ...
  constructor(props){
    ...
    axios.post('http://10.90.90.102:3002/news').then(res=>{
  ...
  render() {
    ...
    const stories = this.state.stories.slice(3,6).map((d) => 
            ...
            <Row style={rowStyle}>
              <Col sm="4">
                <img src="breakingNews.jpeg" height="100px" width="100px" alt="poster"/>
              </Col>
    ...
    <Container>
        <Row>
          ...
          <Col sm="4">
            <Card>
              <CardImg top width="100%" src="breakingNews.jpeg" alt="Card image cap" />
              <CardBody>
