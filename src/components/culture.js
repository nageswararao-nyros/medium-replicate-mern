...
class Culture extends Component {
  ...
  constructor(props){
    ...
    axios.post('http://10.90.90.102:3002/').then(res=>{
  ...
  render() {
    ...
    const stories = this.state.stories.slice(6,9).map((d) => 
            ...
            <Row style={rowStyle}>
              <Col sm="4">
                <img src="culture.jpeg" height="100px" width="100px" alt="poster"/>
              </Col>
    ...
    <Container>
        <Row>
          ...
          <Col sm="4">
            <Card>
              <CardImg top width="100%" src="culture.jpeg" alt="Card image cap" />
              <CardBody>
